<template>
  <section>
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="card shadow mb-4" >
          ...
          <div class="card-body border d-flex flex-row "  >
            
            
              <p><span className="mx-4" style=" color: red; ">DropZone &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span> </p>
          
              <span className="ml-2"><vue-dropzone ref="myVueDropzone" id="dropzone" :options="dropzoneOptions"></vue-dropzone></span>
    ...
    <button @click="saveProduct" type="submit" class="btn btn-lg mx-2 my-2 btn-primary">Save</button>
    <button type="button" class="btn btn-secondary btn-lg mx-2 my-2">Cancel</button>
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    saveProduct() {
      ...
      axios.post('http://127.0.0.1:8000/product', product).then(response => {
        saveProduct()
